...
exports.getTeamRank = exports.getTeamRankingArr = exports.resortColumnsByArray = exports.fetchDataAndProcessAll = exports.fetchDataAndProcess = void 0;
const jsonDatabase_js_1 = require("./jsonDatabase.js");
...
function assignScore(match, dataPoints, weightMap) {
    ...
    for (let i = 0; i < match.length; i++) {
        if (weightMap[dataPoints[i]] === undefined)
            continue;
...
const scoreWeights = Object.assign(Object.assign(Object.assign({}, autoWeights), teleopWeights), endGameWeights);
const ampWeights = {
    'Amp Auto': 1,
    'Amp Teleop': 1,
};
...
// Working:
const fetchDataAndProcess = (eventCode) => __awaiter(void 0, void 0, void 0, function* () {
    const data = yield (0, jsonDatabase_js_1.getAllData)();
    ...
    return Object.assign({ fullData: Object.assign({}, fullData) }, fullData);
});
exports.fetchDataAndProcess = fetchDataAndProcess;
const fetchDataAndProcessAll = () => __awaiter(void 0, void 0, void 0, function* () {
    return (0, exports.fetchDataAndProcess)(eventCode);
});
exports.fetchDataAndProcessAll = fetchDataAndProcessAll;
...
exports.resortColumnsByArray = resortColumnsByArray;
// Working but need to make easier to use:
...
exports.getTeamRankingArr = getTeamRankingArr;
